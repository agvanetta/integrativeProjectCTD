...
INSERT INTO `categorias` VALUES (1,'807.374 hoteles','https://images.pexels.com/photos/258154/pexels-photo-258154.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=650&w=940','Hoteles', NULL),(2,'258.344 hostels','https://t-cf.bstatic.com/xdata/images/hotel/max1024x768/335030057.jpg?k=ad9ca95bc6bd4a12662a53990a2ff5447193ec086b7ff5789bdb56a90532ede9&o=&hp=1','Hostels', NULL),(3,'50.033 departamentos','https://images.pexels.com/photos/1571452/pexels-photo-1571452.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=650&w=940','Departamentos', NULL),(4,'33.499 bed and breakfast','https://t-cf.bstatic.com/xdata/images/hotel/max1024x768/249501228.jpg?k=8e553cf07f6c46436a6e0e9012d216a65fcb8535bbbf8e709685cb5e59289dd6&o=&hp=1','Bed and Breakfast', NULL);
...
CREATE TABLE `ciudades` (
  ...
  CONSTRAINT `FK3wpxqd6g0rmrng79oxd2e2stv` FOREIGN KEY (`pais_id`) REFERENCES `pais` (`id`) ON DELETE CASCADE
...
CREATE TABLE `favoritos` (
  ...
  CONSTRAINT `FKq9wif2hcqfxj8t49wo613wm0h` FOREIGN KEY (`usuario_id`) REFERENCES `usuarios` (`id`) ON DELETE CASCADE,
  CONSTRAINT `FKrxdxytf48cr005vej8540b0rr` FOREIGN KEY (`producto_id`) REFERENCES `productos` (`id`) ON DELETE CASCADE
...
CREATE TABLE `imagenes` (
  ...
  CONSTRAINT `FKhylof04iou23s0pb9ab6pbd4j` FOREIGN KEY (`producto_id`) REFERENCES `productos` (`id`) ON DELETE CASCADE
...
CREATE TABLE `lugares` (
  ...
  CONSTRAINT `FKqnso5gotbokr6l5de9kcapso5` FOREIGN KEY (`ciudad_id`) REFERENCES `ciudades` (`id`) ON DELETE CASCADE
...
CREATE TABLE `productos` (
  ...
  `politicas_id` INT NOT NULL,
  `precio_por_dia` double DEFAULT NULL,
  ...
  KEY `fk_productos_politicas1_idx` (`politicas_id`),
  ...
  CONSTRAINT `FK2fwq10nwymfv7fumctxt9vpgb` FOREIGN KEY (`categoria_id`) REFERENCES `categorias` (`id`) ON DELETE CASCADE,
  CONSTRAINT `FK2n66ase94bg4q6j56jdm4nj17` FOREIGN KEY (`ciudad_id`) REFERENCES `ciudades` (`id`) ON DELETE CASCADE,
  CONSTRAINT `fk_productos_politicas1` FOREIGN KEY (`politicas_id`) REFERENCES `digitalbooking`.`politicas` (`id`),
  CONSTRAINT `FKo8g0kqq9awvgh4elqai7tdhu` FOREIGN KEY (`usuario_id`) REFERENCES `digitalbooking`.`usuarios` (`id`) ON DELETE CASCADE
...
CREATE TABLE IF NOT EXISTS `politicas` (
  ...
  `cancelacion_uno` BIT(1) NOT NULL,
  `cancelacion_dos` BIT(1) NOT NULL,
  `cancelacion_tres` BIT(1) NOT NULL,
  `deposito_seguridad` BIT(1) NOT NULL,
  `detector_humo` BIT(1) NOT NULL,
  `distanciamiento_social` BIT(1) NOT NULL,
  `fiesta` BIT(1) NOT NULL,
  `fumar` BIT(1) NOT NULL,
  PRIMARY KEY (`id`))
ENGINE = InnoDB
AUTO_INCREMENT = 7
...
INSERT INTO `politicas` VALUES (1,"11:00",_binary '',_binary '',_binary '',_binary '',_binary '',_binary '',_binary '',_binary ''),(2,"14:00",_binary '',_binary '',_binary '',_binary '',_binary '',_binary '',_binary '',_binary ''),(3,"11:00",_binary '',_binary '',_binary '',_binary '',_binary '',_binary '',_binary '',_binary ''),(4,"10:00",_binary '',_binary '',_binary '',_binary '',_binary '',_binary '',_binary '',_binary ''),(5,"10:00",_binary '',_binary '',_binary '',_binary '',_binary '',_binary '',_binary '',_binary ''),(6,"10:00",_binary '',_binary '',_binary '',_binary '',_binary '',_binary '',_binary '',_binary ''),(7,"10:00",_binary '',_binary '',_binary '',_binary '',_binary '',_binary '',_binary '',_binary ''),(8,"10:00",_binary '',_binary '',_binary '',_binary '',_binary '',_binary '',_binary '',_binary ''),(9,"10:00",_binary '',_binary '',_binary '',_binary '',_binary '',_binary '',_binary '',_binary ''),(10,"10:00",_binary '',_binary '',_binary '',_binary '',_binary '',_binary '',_binary '',_binary ''),(11,"10:00",_binary '',_binary '',_binary '',_binary '',_binary '',_binary '',_binary '',_binary ''),(12,"10:00",_binary '',_binary '',_binary '',_binary '',_binary '',_binary '',_binary '',_binary ''),(13,"10:00",_binary '',_binary '',_binary '',_binary '',_binary '',_binary '',_binary '',_binary ''),(14,"10:00",_binary '',_binary '',_binary '',_binary '',_binary '',_binary '',_binary '',_binary ''),(15,"10:00",_binary '',_binary '',_binary '',_binary '',_binary '',_binary '',_binary '',_binary ''),(16,"10:00",_binary '',_binary '',_binary '',_binary '',_binary '',_binary '',_binary '',_binary ''),(17,"10:00",_binary '',_binary '',_binary '',_binary '',_binary '',_binary '',_binary '',_binary ''),(18,"10:00",_binary '',_binary '',_binary '',_binary '',_binary '',_binary '',_binary '',_binary ''),(19,"10:00",_binary '',_binary '',_binary '',_binary '',_binary '',_binary '',_binary '',_binary ''),(20,"10:00",_binary '',_binary '',_binary '',_binary '',_binary '',_binary '',_binary '',_binary ''),(21,"10:00",_binary '',_binary '',_binary '',_binary '',_binary '',_binary '',_binary '',_binary ''),(22,"10:00",_binary '',_binary '',_binary '',_binary '',_binary '',_binary '',_binary '',_binary ''),(23,"10:00",_binary '',_binary '',_binary '',_binary '',_binary '',_binary '',_binary '',_binary ''),(24,"10:00",_binary '',_binary '',_binary '',_binary '',_binary '',_binary '',_binary '',_binary ''),(25,"10:00",_binary '',_binary '',_binary '',_binary '',_binary '',_binary '',_binary '',_binary ''),(26,"10:00",_binary '',_binary '',_binary '',_binary '',_binary '',_binary '',_binary '',_binary ''),(27,"10:00",_binary '',_binary '',_binary '',_binary '',_binary '',_binary '',_binary '',_binary ''),(28,"10:00",_binary '',_binary '',_binary '',_binary '',_binary '',_binary '',_binary '',_binary ''),(29,"10:00",_binary '',_binary '',_binary '',_binary '',_binary '',_binary '',_binary '',_binary ''),(30,"10:00",_binary '',_binary '',_binary '',_binary '',_binary '',_binary '',_binary '',_binary ''),(31,"10:00",_binary '',_binary '',_binary '',_binary '',_binary '',_binary '',_binary '',_binary ''),(32,"10:00",_binary '',_binary '',_binary '',_binary '',_binary '',_binary '',_binary '',_binary '');
...
CREATE TABLE `puntuaciones` (
  ...
  KEY `FK19r0v6g9196r78rdh3tt5x2f3` (`reserva_id`),
  CONSTRAINT `FKf3ipc1ss30u5lf6qe5es8gue1` FOREIGN KEY (`usuario_id`) REFERENCES `usuarios` (`id`) ON DELETE CASCADE,
  CONSTRAINT `FKqep6jym4fop6gtxjdux9ioayd` FOREIGN KEY (`producto_id`) REFERENCES `productos` (`id`) ON DELETE CASCADE,
  CONSTRAINT `FK19r0v6g9196r78rdh3tt5x2f3` FOREIGN KEY (`reserva_id`) REFERENCES `digitalbooking`.`reservas` (`id`) ON DELETE CASCADE
...
CREATE TABLE `reservas` (
  ...
  `email_enviado` BIT(1) NULL DEFAULT NULL,
  ...
  CONSTRAINT `fk_reservas_productos1` FOREIGN KEY (`producto_id`) REFERENCES `productos` (`id`) ON DELETE CASCADE,
  CONSTRAINT `fk_reservas_usuarios1` FOREIGN KEY (`usuarios_id`) REFERENCES `usuarios` (`id`) ON DELETE CASCADE
...
INSERT INTO `reservas` VALUES (1,'11:00:00','2022-07-15','2022-08-01',1,1,NULL,NULL,NULL,NULL,NULL,NULL,_binary ''),(2,'11:00:00','2022-07-15','2022-08-01',2,2,NULL,NULL,NULL,NULL,NULL,NULL,_binary ''),(3,'11:00:00','2022-07-15','2022-08-01',3,1,NULL,NULL,NULL,NULL,NULL,NULL,_binary ''),(4,'11:00:00','2022-07-15','2022-08-01',4,2,NULL,NULL,NULL,NULL,NULL,NULL,_binary ''),(5,'11:00:00','2022-07-15','2022-08-01',5,1,NULL,NULL,NULL,NULL,NULL,NULL,_binary ''),(6,'11:00:00','2022-07-15','2022-08-01',6,2,NULL,NULL,NULL,NULL,NULL,NULL,_binary ''),(7,'11:00:00','2022-07-15','2022-08-01',7,1,NULL,NULL,NULL,NULL,NULL,NULL,_binary ''),(8,'11:00:00','2022-07-15','2022-08-01',8,2,NULL,NULL,NULL,NULL,NULL,NULL,_binary ''),(9,'11:00:00','2022-07-15','2022-08-01',9,1,NULL,NULL,NULL,NULL,NULL,NULL,_binary ''),(10,'11:00:00','2022-07-15','2022-08-01',10,2,NULL,NULL,NULL,NULL,NULL,NULL,_binary ''),(11,'11:00:00','2022-08-10','2022-08-20',11,1,NULL,NULL,NULL,NULL,NULL,NULL,_binary ''),(12,'11:00:00','2022-08-10','2022-08-20',12,2,NULL,NULL,NULL,NULL,NULL,NULL,_binary ''),(13,'11:00:00','2022-08-10','2022-08-20',13,1,NULL,NULL,NULL,NULL,NULL,NULL,_binary ''),(14,'11:00:00','2022-08-10','2022-08-20',14,2,NULL,NULL,NULL,NULL,NULL,NULL,_binary ''),(15,'11:00:00','2022-08-10','2022-08-20',15,1,NULL,NULL,NULL,NULL,NULL,NULL,_binary ''),(16,'11:00:00','2022-08-10','2022-08-20',16,2,NULL,NULL,NULL,NULL,NULL,NULL,_binary ''),(17,'11:00:00','2022-08-10','2022-08-20',17,1,NULL,NULL,NULL,NULL,NULL,NULL,_binary ''),(18,'11:00:00','2022-08-10','2022-08-20',18,2,NULL,NULL,NULL,NULL,NULL,NULL,_binary ''),(19,'11:00:00','2022-09-01','2022-10-01',1,1,NULL,NULL,NULL,NULL,NULL,NULL,_binary ''),(20,'11:00:00','2022-10-01','2022-11-01',1,2,NULL,NULL,NULL,NULL,NULL,NULL,_binary ''),(21,'19:00:00','2022-12-03','2022-12-05',1,1,'Pérez',NULL,'sergio.perez@gmail.com','Sergio','+541169611987',NULL,_binary ''),(22,'19:00:00','2022-12-04','2022-12-05',4,1,'Pérez',NULL,'sergio@gmail.com','Rocio','+541169611987',NULL,_binary '');
...
CREATE TABLE `usuarios` (
  ...
  CONSTRAINT `fk_usuarios_roles1` FOREIGN KEY (`roles_id`) REFERENCES `roles` (`id`) ON DELETE CASCADE
...
INSERT INTO `usuarios` VALUES (1,'Sergio','Pérez','sergio.perez@test.com','+541169611987','$2a$10$jGuBpsumk2.wnqeCS.UOa.NKBsDj9dNFzoret9xOUXua1TlEVZmU.',1,_binary '\1','G65pPHTjocIHzLfA33dUeU2Ndv7talbC7lERZGzUR9Ita4CE796DQkMWYOdRWY0d'),(2,'Lionel','Messi','lionel.messi@test.com','+541169611987','$2a$10$qWqrpluxwafauAL5GupN5.3BQU93VpuwUBAWAIbAa2AOwqS9YNTJy',2,_binary '\0',NULL),(9,'Rocio','Bottinelli','rociobottinelli@gmail.com','+573115556181','$2a$10$.8ykT/fyAoC1DUHOk9075.yTFxAsagjXHEkZFR4tn5xgtEBO3DPNu',2,_binary '','BhudvcWlnnUTkmKaQHoh0os27FZyAUePI2WXyKSYKTm8gYCPuOBDTRuua19dSRqz');
...
BEGIN
UPDATE categorias cat INNER JOIN productos prod ON prod.categoria_id = cat.id 
SET cat.cant_productos = (SELECT count(prod.categoria_id) FROM productos prod
WHERE prod.categoria_id = cat.id GROUP BY cat.id);
SELECT * FROM categorias ORDER BY categorias.id;
END$$
...
-- Dump completed on 2022-06-27 18:55:13

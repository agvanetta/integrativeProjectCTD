...
import { faBars, faStar, faStarHalfStroke } from "@fortawesome/free-solid-svg-icons";
import { faCalendarDay, faSnowflake, faPaw, faCar
  ,faPersonSwimming, faWifi  } from "@fortawesome/free-solid-svg-icons";
  import { faHeart } from "@fortawesome/free-regular-svg-icons";
import { faEye, faEyeSlash, faFireBurner
   } from "@fortawesome/free-solid-svg-icons";

import "../styles/fontAwesonwIcon.css";

export const imgHeart = (
  <FontAwesomeIcon icon={faHeart} />
);
export const imgWifi = (
...
export const imgOven = (
  <FontAwesomeIcon icon={faFireBurner} />
);
export const imgSnow = (
